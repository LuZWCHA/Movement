...
public interface OpenglEnum {
     ...
     int GL_MAX_PROGRAM_TEXTURE_GATHER_COMPONENTS=0x8F9F;
     ...
     int GL_TEXTURE_CUBE_MAP_SEAMLESS_ARB=0x884F;
     ...
     int GL_DRAW_FRAMEBUFFER_BINDING_ANGLE=0x8CA6;
     int GL_READ_FRAMEBUFFER_ANGLE=0x8CA8;
     int GL_DRAW_FRAMEBUFFER_ANGLE=0x8CA9;
     int GL_READ_FRAMEBUFFER_BINDING_ANGLE=0x8CAA;
     ...
     int GL_VERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE=0x88FE;
     int GL_PACK_REVERSE_ROW_ORDER_ANGLE=0x93A4;
     int GL_PROGRAM_BINARY_ANGLE=0x93A6;
     int GL_COMPRESSED_RGB_S3TC_DXT1_ANGLE=0x83F0;
     int GL_COMPRESSED_RGBA_S3TC_DXT1_ANGLE=0x83F1;
     int GL_COMPRESSED_RGBA_S3TC_DXT3_ANGLE=0x83F2;
     int GL_COMPRESSED_RGBA_S3TC_DXT5_ANGLE=0x83F3;
     int GL_TEXTURE_USAGE_ANGLE=0x93A2;
     int GL_FRAMEBUFFER_ATTACHMENT_ANGLE=0x93A3;
     int GL_QUERY_COUNTER_BITS_ANGLE=0x8864;
     int GL_CURRENT_QUERY_ANGLE=0x8865;
     int GL_QUERY_RESULT_ANGLE=0x8866;
     int GL_QUERY_RESULT_AVAILABLE_ANGLE=0x8867;
     int GL_TIME_ELAPSED_ANGLE=0x88BF;
     int GL_TIMESTAMP_ANGLE=0x8E28;
     int GL_TRANSLATED_SHADER_SOURCE_LENGTH_ANGLE=0x93A0;
     ...
     int GL_MAP_PERSISTENT_BIT=0x00000040;
     int GL_MAP_COHERENT_BIT=0x00000080;
     int GL_DYNAMIC_STORAGE_BIT=0x0100;
     int GL_CLIENT_STORAGE_BIT=0x0200;
     ...
     int GL_TEXTURE_POINT_MODE_ATIX=0x60B0;
     int GL_TEXTURE_POINT_ONE_COORD_ATIX=0x60B1;
     int GL_TEXTURE_POINT_SPRITE_ATIX=0x60B2;
     int GL_POINT_SPRITE_CULL_MODE_ATIX=0x60B3;
     int GL_POINT_SPRITE_CULL_CENTER_ATIX=0x60B4;
     int GL_POINT_SPRITE_CULL_CLIP_ATIX=0x60B5;
     int GL_MODULATE_ADD_ATIX=0x8744;
     int GL_MODULATE_SIGNED_ADD_ATIX=0x8745;
     int GL_MODULATE_SUBTRACT_ATIX=0x8746;
     int GL_SECONDARY_COLOR_ATIX=0x8747;
     int GL_TEXTURE_OUTPUT_RGB_ATIX=0x8748;
     int GL_TEXTURE_OUTPUT_ALPHA_ATIX=0x8749;
     int GL_OUTPUT_POINT_SIZE_ATIX=0x610E;
     ...
     int GL_FRAGMENT_LIGHTING_EXT=0x8400;
     int GL_FRAGMENT_COLOR_MATERIAL_EXT=0x8401;
     int GL_FRAGMENT_COLOR_MATERIAL_FACE_EXT=0x8402;
     int GL_FRAGMENT_COLOR_MATERIAL_PARAMETER_EXT=0x8403;
     int GL_MAX_FRAGMENT_LIGHTS_EXT=0x8404;
     int GL_MAX_ACTIVE_LIGHTS_EXT=0x8405;
     int GL_CURRENT_RASTER_NORMAL_EXT=0x8406;
     int GL_LIGHT_ENV_MODE_EXT=0x8407;
     int GL_FRAGMENT_LIGHT_MODEL_LOCAL_VIEWER_EXT=0x8408;
     int GL_FRAGMENT_LIGHT_MODEL_TWO_SIDE_EXT=0x8409;
     int GL_FRAGMENT_LIGHT_MODEL_AMBIENT_EXT=0x840A;
     int GL_FRAGMENT_LIGHT_MODEL_NORMAL_INTERPOLATION_EXT=0x840B;
     int GL_FRAGMENT_LIGHT0_EXT=0x840C;
     int GL_FRAGMENT_LIGHT7_EXT=0x8413;
     ...
     int GL_ALPHA16_EXT=0x803E;
     int GL_LUMINANCE4_EXT=0x803F;
     int GL_LUMINANCE8_EXT=0x8040;
     int GL_LUMINANCE12_EXT=0x8041;
     int GL_LUMINANCE16_EXT=0x8042;
     int GL_LUMINANCE4_ALPHA4_EXT=0x8043;
     int GL_LUMINANCE6_ALPHA2_EXT=0x8044;
     int GL_LUMINANCE8_ALPHA8_EXT=0x8045;
     int GL_LUMINANCE12_ALPHA4_EXT=0x8046;
     int GL_LUMINANCE12_ALPHA12_EXT=0x8047;
     int GL_LUMINANCE16_ALPHA16_EXT=0x8048;
     int GL_INTENSITY_EXT=0x8049;
     int GL_INTENSITY4_EXT=0x804A;
     int GL_INTENSITY8_EXT=0x804B;
     int GL_INTENSITY12_EXT=0x804C;
     int GL_INTENSITY16_EXT=0x804D;
     int GL_RGB2_EXT=0x804E;
     int GL_RGB4_EXT=0x804F;
     int GL_RGB5_EXT=0x8050;
     int GL_RGB8_EXT=0x8051;
     int GL_RGB10_EXT=0x8052;
     int GL_RGB12_EXT=0x8053;
     int GL_RGB16_EXT=0x8054;
     int GL_RGBA2_EXT=0x8055;
     int GL_RGBA4_EXT=0x8056;
     int GL_RGB5_A1_EXT=0x8057;
     int GL_RGBA8_EXT=0x8058;
     int GL_RGB10_A2_EXT=0x8059;
     int GL_RGBA12_EXT=0x805A;
     int GL_RGBA16_EXT=0x805B;
     int GL_TEXTURE_RED_SIZE_EXT=0x805C;
     int GL_TEXTURE_GREEN_SIZE_EXT=0x805D;
     int GL_TEXTURE_BLUE_SIZE_EXT=0x805E;
     int GL_TEXTURE_ALPHA_SIZE_EXT=0x805F;
     int GL_TEXTURE_LUMINANCE_SIZE_EXT=0x8060;
     int GL_TEXTURE_INTENSITY_SIZE_EXT=0x8061;
     int GL_REPLACE_EXT=0x8062;
     int GL_PROXY_TEXTURE_1D_EXT=0x8063;
     int GL_PROXY_TEXTURE_2D_EXT=0x8064;
     ...
     int GL_TEXTURE_BINDING_CUBE_MAP_EXT=0x8514;
     int GL_TEXTURE_CUBE_MAP_POSITIVE_X_EXT=0x8515;
     int GL_TEXTURE_CUBE_MAP_NEGATIVE_X_EXT=0x8516;
     int GL_TEXTURE_CUBE_MAP_POSITIVE_Y_EXT=0x8517;
     int GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_EXT=0x8518;
     int GL_TEXTURE_CUBE_MAP_POSITIVE_Z_EXT=0x8519;
     int GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_EXT=0x851A;
     int GL_PROXY_TEXTURE_CUBE_MAP_EXT=0x851B;
     int GL_MAX_CUBE_MAP_TEXTURE_SIZE_EXT=0x851C;
     int GL_CLAMP_TO_EDGE_EXT=0x812F;
     ...
     int GL_PERFQUERY_SINGLE_CONTEXT_INTEL=0x0000;
     int GL_PERFQUERY_GLOBAL_CONTEXT_INTEL=0x0001;
     ...
     int GL_KTX_FRONT_REGION=0x0;
     int GL_KTX_BACK_REGION=0x1;
     int GL_KTX_Z_REGION=0x2;
     int GL_KTX_STENCIL_REGION=0x3;
     ...
     int GL_SAMPLE_COUNT_BITS_NV=0x8864;
     int GL_CURRENT_SAMPLE_COUNT_QUERY_NV=0x8865;
     int GL_QUERY_RESULT_NV=0x8866;
     int GL_QUERY_RESULT_AVAILABLE_NV=0x8867;
     int GL_SAMPLE_COUNT_NV=0x8914;
     ...
     int MAX_VERTEX_TEXTURE_IMAGE_UNITS_ARB=0x8B4C;
     ...
     int GL_TEXCOORD4_BIT_PGI=0x80000000;
     int GL_ERROR_REGAL=0x9322;
     int GL_DEBUG_REGAL=0x9323;
     int GL_LOG_REGAL=0x9324;
     int GL_EMULATION_REGAL=0x9325;
     int GL_DRIVER_REGAL=0x9326;
     int GL_MISSING_REGAL=0x9360;
     int GL_TRACE_REGAL=0x9361;
     int GL_CACHE_REGAL=0x9362;
     int GL_CODE_REGAL=0x9363;
     int GL_STATISTICS_REGAL=0x9364;
     int GL_LOG_ERROR_REGAL=0x9319;
     int GL_LOG_WARNING_REGAL=0x931A;
     int GL_LOG_INFO_REGAL=0x931B;
     int GL_LOG_APP_REGAL=0x931C;
     int GL_LOG_DRIVER_REGAL=0x931D;
     int GL_LOG_INTERNAL_REGAL=0x931E;
     int GL_LOG_DEBUG_REGAL=0x931F;
     int GL_LOG_STATUS_REGAL=0x9320;
     int GL_LOG_HTTP_REGAL=0x9321;
     ...
     int GL_EXTENDED_RANGE_SGIS=0x85A5;
     int GL_MIN_RED_SGIS=0x85A6;
     int GL_MAX_RED_SGIS=0x85A7;
     int GL_MIN_GREEN_SGIS=0x85A8;
     int GL_MAX_GREEN_SGIS=0x85A9;
     int GL_MIN_BLUE_SGIS=0x85AA;
     int GL_MAX_BLUE_SGIS=0x85AB;
     int GL_MIN_ALPHA_SGIS=0x85AC;
     int GL_MAX_ALPHA_SGIS=0x85AD;
     ...
     int GL_RGB_SIGNED_SGIX=0x85E0;
     int GL_RGBA_SIGNED_SGIX=0x85E1;
     int GL_ALPHA_SIGNED_SGIX=0x85E2;
     int GL_LUMINANCE_SIGNED_SGIX=0x85E3;
     int GL_INTENSITY_SIGNED_SGIX=0x85E4;
     int GL_LUMINANCE_ALPHA_SIGNED_SGIX=0x85E5;
     int GL_RGB16_SIGNED_SGIX=0x85E6;
     int GL_RGBA16_SIGNED_SGIX=0x85E7;
     int GL_ALPHA16_SIGNED_SGIX=0x85E8;
     int GL_LUMINANCE16_SIGNED_SGIX=0x85E9;
     int GL_INTENSITY16_SIGNED_SGIX=0x85EA;
     int GL_LUMINANCE16_ALPHA16_SIGNED_SGIX=0x85EB;
     int GL_RGB_EXTENDED_RANGE_SGIX=0x85EC;
     int GL_RGBA_EXTENDED_RANGE_SGIX=0x85ED;
     int GL_ALPHA_EXTENDED_RANGE_SGIX=0x85EE;
     int GL_LUMINANCE_EXTENDED_RANGE_SGIX=0x85EF;
     int GL_INTENSITY_EXTENDED_RANGE_SGIX=0x85F0;
     int GL_LUMINANCE_ALPHA_EXTENDED_RANGE_SGIX=0x85F1;
     int GL_RGB16_EXTENDED_RANGE_SGIX=0x85F2;
     int GL_RGBA16_EXTENDED_RANGE_SGIX=0x85F3;
     int GL_ALPHA16_EXTENDED_RANGE_SGIX=0x85F4;
     int GL_LUMINANCE16_EXTENDED_RANGE_SGIX=0x85F5;
     int GL_INTENSITY16_EXTENDED_RANGE_SGIX=0x85F6;
     int GL_LUMINANCE16_ALPHA16_EXTENDED_RANGE_SGIX=0x85F7;
     int GL_MIN_LUMINANCE_SGIS=0x85F8;
     int GL_MAX_LUMINANCE_SGIS=0x85F9;
     int GL_MIN_INTENSITY_SGIS=0x85FA;
     int GL_MAX_INTENSITY_SGIS=0x85FB;
     ...
     int GL_POST_COLOR_MATRIX_RED_SCALE_SGI=0x80B4;
     int GL_POST_COLOR_MATRIX_GREEN_SCALE_SGI=0x80B5;
     int GL_POST_COLOR_MATRIX_BLUE_SCALE_SGI=0x80B6;
     int GL_POST_COLOR_MATRIX_ALPHA_SCALE_SGI=0x80B7;
     int GL_POST_COLOR_MATRIX_RED_BIAS_SGI=0x80B8;
     int GL_POST_COLOR_MATRIX_GREEN_BIAS_SGI=0x80B9;
     int GL_POST_COLOR_MATRIX_BLUE_BIAS_SGI=0x80BA;
     int GL_POST_COLOR_MATRIX_ALPHA_BIAS_SGI=0x80BB;
     ...
     int GL_RESTART_SUN=0x01;
     int GL_REPLACE_MIDDLE_SUN=0x02;
     int GL_REPLACE_OLDEST_SUN=0x03;
