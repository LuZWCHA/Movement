...
import com.nowandfuture.mod.core.client.renderers.WorldLightChangeListener;
        ...
        if(entity != null) {
            ...
            for (RenderCube cube :
                ...
                if(cube.isToUpdate() && !cube.isCompiling()){
                    ...
                    ModuleRenderManager.INSTANCE.execute(new CubeRenderWorker(cube.getCubeCompileTask()));
                }
            }
