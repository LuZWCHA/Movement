package com.nowandfuture.mod.core.client.renderers.cubes;
...
public class CubeRenderWorker implements Runnable,Comparable<CubeRenderWorker> {

    private CubeCompileTask cubeCompileTask;
    private RegionRenderCacheBuilder regionRenderCacheBuilder;

    public CubeRenderWorker(CubeCompileTask task){
                        ...
                        public void onSuccess(@Nullable List<Object> result) {
                            ...
                            try {
                                if (cubeCompileTask.getStatus() == CubeCompileTask.Status.COMPILED) {
                                    ...
                                    CubeRenderWorker.this.regionRenderCacheBuilder = null;
...
//                            cubeCompileTask.setStatus(CubeCompileTask.Status.PENDING);
    ...
    @Override
    public int compareTo(CubeRenderWorker o) {
