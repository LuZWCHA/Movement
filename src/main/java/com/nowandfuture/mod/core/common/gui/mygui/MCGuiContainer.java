...
//    protected boolean dragSplitting;
    ...
    public MCGuiContainer(Container inventorySlotsIn)
    {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            this.buttonList.get(i1).drawButton(this.mc, mouseX, mouseY, partialTicks);
        }

        for (int j1 = 0; j1 < this.labelList.size(); ++j1)
        {
            this.labelList.get(j1).drawLabel(this.mc, mouseX, mouseY);
        }
