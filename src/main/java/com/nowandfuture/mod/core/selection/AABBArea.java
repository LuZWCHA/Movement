...
public class AABBArea {
        ...
        public AABBArea(double x1, double y1, double z1, double x2, double y2, double z2)
        {
        ...
        public AABBArea(BlockPos pos)
        {
            this((double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), (double)(pos.getX() + 1), (double)(pos.getY() + 1), (double)(pos.getZ() + 1));
        }

        public AABBArea(BlockPos pos1, BlockPos pos2)
        {
            this((double)pos1.getX(), (double)pos1.getY(), (double)pos1.getZ(), (double)pos2.getX(), (double)pos2.getY(), (double)pos2.getZ());
        }

        @SideOnly(Side.CLIENT)
        public AABBArea(Vec3d min, Vec3d max)
        {
            this(min.x, min.y, min.z, max.x, max.y, max.z);
        }

        /**
         * Helper method that returns a new {@link net.minecraft.util.math.AxisAlignedBB} with the given value for {@link #maxY} and all other
         * values taken from this bounding box.
         */
        public net.minecraft.util.math.AxisAlignedBB setMaxY(double y2)
        {
            return new net.minecraft.util.math.AxisAlignedBB(this.minX, this.minY, this.minZ, this.maxX, y2, this.maxZ);
        }
        ...
        public boolean equals(Object p_equals_1_)
        {
            ...
            else if (!(p_equals_1_ instanceof net.minecraft.util.math.AxisAlignedBB))
            {
                return false;
            }
            else
            {
                net.minecraft.util.math.AxisAlignedBB axisalignedbb = (net.minecraft.util.math.AxisAlignedBB)p_equals_1_;
        ...
        /**
         * Creates a new {@link net.minecraft.util.math.AxisAlignedBB} that has been contracted by the given amount, with positive changes
         ...
         */
        public net.minecraft.util.math.AxisAlignedBB contract(double x, double y, double z)
        {
            double d0 = this.minX;
            double d1 = this.minY;
            double d2 = this.minZ;
            ...
            return new net.minecraft.util.math.AxisAlignedBB(d0, d1, d2, d3, d4, d5);
        }

        /**
         * Creates a new {@link net.minecraft.util.math.AxisAlignedBB} that has been expanded by the given amount, with positive changes increasing
         ...
         */
        public net.minecraft.util.math.AxisAlignedBB expand(double x, double y, double z)
        {
            double d0 = this.minX;
            double d1 = this.minY;
            double d2 = this.minZ;
        ...
        /**
         * Creates a new {@link net.minecraft.util.math.AxisAlignedBB} that has been contracted by the given amount in both directions. Negative
         ...
         */
        public net.minecraft.util.math.AxisAlignedBB grow(double x, double y, double z)
        {
        ...
        /**
         * Creates a new {@link net.minecraft.util.math.AxisAlignedBB} that is expanded by the given value in all directions. Equivalent to {@link
         ...
         */
        public net.minecraft.util.math.AxisAlignedBB grow(double value)
        {
            return this.grow(value, value, value);
        }

        public net.minecraft.util.math.AxisAlignedBB intersect(net.minecraft.util.math.AxisAlignedBB other)
        {
        ...
        public net.minecraft.util.math.AxisAlignedBB union(net.minecraft.util.math.AxisAlignedBB other)
        {
         ...
         */
        public net.minecraft.util.math.AxisAlignedBB offset(double x, double y, double z)
        {
            return new net.minecraft.util.math.AxisAlignedBB(this.minX + x, this.minY + y, this.minZ + z, this.maxX + x, this.maxY + y, this.maxZ + z);
        }

        public net.minecraft.util.math.AxisAlignedBB offset(BlockPos pos)
        {
            return new net.minecraft.util.math.AxisAlignedBB(this.minX + (double)pos.getX(), this.minY + (double)pos.getY(), this.minZ + (double)pos.getZ(), this.maxX + (double)pos.getX(), this.maxY + (double)pos.getY(), this.maxZ + (double)pos.getZ());
        }

        public net.minecraft.util.math.AxisAlignedBB offset(Vec3d vec)
        {
         ...
         */
        public double calculateXOffset(net.minecraft.util.math.AxisAlignedBB other, double offsetX)
        {
         ...
         * calculated offset.  Otherwise return the calculated offset.
         */
        public double calculateYOffset(net.minecraft.util.math.AxisAlignedBB other, double offsetY)
        {
         ...
         * calculated offset.  Otherwise return the calculated offset.
         */
        public double calculateZOffset(net.minecraft.util.math.AxisAlignedBB other, double offsetZ)
        {
         ...
         */
        public boolean intersects(net.minecraft.util.math.AxisAlignedBB other)
        {
         ...
         * @return A modified AABB.
         */
        public net.minecraft.util.math.AxisAlignedBB shrink(double value)
        {
